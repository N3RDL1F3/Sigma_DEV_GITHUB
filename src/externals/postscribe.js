...
(function ()
{
    ...
    var global = this.getSDG().getRes()[getSDG().getSetup().RESOURCES.POSTSCRIBE];
    ...
    global.postscribe = (function ()
    {
        ...
        var queue = [];
        var active = null;
        var psDebug = getSDG().getRes().get(getSDG().getSetup().RESOURCES.POSTSCRIBE)._debugModus;
        function nextStream()
        {
        ...
        function runStream(el, html, options)
        {
            ...
            if (psDebug) {
                getSDG().log('SYSTEM: POSTSCRIBE: Starting write stream, document.write overwritten.', getSDG().loglvl('DEBUG'));
            }
            set(doc, {
                close: doNothing,
                open: doNothing,
            ...
            active.write(html, function streamDone()
            {
                ...
                active = null;
                if (psDebug) {
                    getSDG().log('SYSTEM: POSTSCRIBE: Stoping write stream, document.write back to default.', getSDG().loglvl('DEBUG'));
                }
                nextStream();
            });
            return active;
